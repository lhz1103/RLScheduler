...
class heuristic:
    ...
    def train(self, max_episodes=1000, update_interval=2048):
        ...
        for episode in range(max_episodes):
            ...
            episode_log_path = os.path.join(episode_log_dir, f"{self.strategy}_actions_log.csv")
...
if __name__ == "__main__":
    ...
    num_nodes = 16
    episodes = 1
    arrival_rate_set = [12, 16, 24]

    for arr in arrival_rate_set:
        env = JobSchedulingEnv(num_nodes=4, budget_factor=10, privacy_rate=0, wait_factor=0.115, job_runtime=1.0, arrival_rate=arr)
