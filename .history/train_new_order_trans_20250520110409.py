...
class PPO:
    def __init__(self, env, device='cuda', 
        ...
        # 存储数据路径
        self.figures_path = os.path.expanduser(f"~/starburst/RLscheduler/test_4transformer_8head_reward_mod_{self.env.beta}beta")
    ...
    def collect_sjf_batch(self, steps=2000, batch_size=512):
        """
        用交叉熵让Actor模仿SJF
        """
