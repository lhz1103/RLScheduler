...
class ActorNetwork(nn.Module):
    def __init__(self, num_nodes: int, num_gpus: int, max_jobs: int, hidden_dim: int=256, num_heads: int = 8, embed_dim: int = 32, num_layers: int = 6):  # max_jobs就是Env里的max_jobs_per_ts
        """
        Actor网络定义
...
class CriticNetwork(nn.Module):
    def __init__(self, num_nodes: int, num_gpus: int, max_jobs: int, hidden_dim: int=256, num_heads: int = 4, embed_dim: int = 32, num_layers: int = 6):
        """
        Critic网络定义
