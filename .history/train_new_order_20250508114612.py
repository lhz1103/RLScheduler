...
class PPO:
    ...
    def preprocess_state(self, state, to_gpu:bool = True):
        ...
        return {
            ...
            'spent_ratio': torch.tensor(state["spent_ratio"], dtype=torch.float32, device=device).unsqueeze(0)
        }
    ...
    def update(self):
        ...
        spent_b    = torch.stack([self.preprocess_state(s)['spent_ratio'].squeeze(0) for s in states])
