...
class PPO:
    def __init__(self, env, device='cuda', 
        ...
        # 存储数据路径
        self.figures_path = os.path.expanduser(f"~/starburst/RLscheduler/test_4transformer_8head_reward_mod_defalut_pretrain")
    ...
    def pretrain_imitation(self,
                       steps=3000,
                       batch_size=1024,
                       ckpt_path="pretrain_actor_default_2000steps_1024bs.pth"):
