...
class heuristic:
    def __init__(self, env, strategy = 'FIFO'):  
        ...
        self.figures_path = f"~/starburst/RLscheduler/test_4transformer_8head_reward_mod_defalut_pretrain/evaluation" 
    ...
    def train(self, max_episodes=1000, update_interval=2048):
        ...
        csv_dir = os.path.expanduser("~/starburst/RLscheduler/Pareto_curves/ex_arrival_rate_oldmodel")
...
if __name__ == "__main__":
    ...
    from JobSchedulingEnv_new_order_trans import JobSchedulingEnv  # 如果加上提前预测上云的算法呢
    
    # 创建环境
    num_nodes = 16
    episodes = 50
    """
    arrival_rate_set = [30, 45, 60, 90, 120]
