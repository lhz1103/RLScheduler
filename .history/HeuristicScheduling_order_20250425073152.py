...
if __name__ == "__main__":
    ...
    LWTF = heuristic(env, strategy = 'LongestWaitingTimeFirst_constant')
    ...
    HCF = heuristic(env, strategy = 'HighestCostFirst_constat')
    rewards_HCF = HCF.train(max_episodes=500)

    LCF = heuristic(env, strategy = 'LowestCostFirst_constat')
