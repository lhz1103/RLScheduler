class Job(object):
    ...
    def __repr__(self):
        return f'Job(idx={self.idx}, gpus={self.num_gpus}, arr={self.arrival}, timeslot={self.timeslot}, run = {self.runtime}, deadline={self.deadline}, start={self.start}, privacy={self.privacy})\n'
